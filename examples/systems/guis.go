...
func GUIs() {
	...
	var hud = gui.NewFromXMLs(cam, gui.NewElementsXML(
		...
		gui.Theme("label", f.Color, "0 0 0 0", f.Width, "150", f.Height, "50", f.GapX, "10", f.GapY, "10",
			f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20", f.EdgeBottom, "20",
		...
		gui.Theme("button", f.Color, "220 220 220 255", f.Width, "150", f.Height, "50", f.GapX, "10", f.GapY, "10",
			f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20", f.EdgeBottom, "20",
			f.AssetId, ninePatch[2], f.TextAlignmentX, "0.5", f.TextAlignmentY, "0.3", f.TextColor, "80 80 80 255",
			f.TextLineHeight, "35", f.ButtonThemeIdHover, "button-hover", f.ButtonThemeIdPress, "button-press",
			f.TooltipId, "tooltip", f.SliderStep, "0.1", f.SliderHandleAssetId, ninePatch[14],
		...
		gui.Theme("button-hover", f.Color, "255 255 255 255", f.Width, "150", f.Height, "50",
			f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20",
			f.EdgeBottom, "20", f.AssetId, ninePatch[5], f.TextAlignmentX, "0.5", f.TextAlignmentY, "0.3",
		...
		gui.Theme("button-press", f.Color, "200 200 200 255", f.Width, "150", f.Height, "50",
			f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20", f.EdgeBottom, "20",
			f.AssetId, ninePatch[4], f.TextAlignmentX, "0.5", f.TextAlignmentY, "0.6", f.TextColor, "80 80 80 255",
		...
		gui.Theme("checkbox-on", f.Color, "220 220 220 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20", f.EdgeBottom, "20",
			f.AssetId, ninePatch[9], f.TextColor, "80 80 80 255", f.TextLineHeight, "35",
		...
		gui.Theme("checkbox-on-hover", f.Color, "255 255 255 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20", f.EdgeBottom, "20",
			f.AssetId, ninePatch[9], f.TextColor, "80 80 80 255", f.TextLineHeight, "35", f.Text, "X",
		...
		gui.Theme("checkbox-off", f.Color, "220 220 220 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			...
			f.AssetId, ninePatch[9], f.TooltipId, "tooltip", f.TooltipText, "Currently off!"),
		gui.Theme("checkbox-off-hover", f.Color, "255 255 255 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.EdgeLeft, "20", f.EdgeRight, "20", f.EdgeTop, "20", f.EdgeBottom, "20",
			f.AssetId, ninePatch[9]),
		...
		gui.Visual("background", f.FillContainer, "", f.AssetId, ninePatch[8], f.Color, "200 200 200 255"),
		gui.Visual("name-label", f.ThemeId, "label", f.Text, "Name", f.TooltipText, "Wow, tooltip for labels!"),
		gui.InputField("name", f.Width, "250", f.AssetId, ninePatch[9], f.Text, "Kenney", f.InputFieldMargin, "10",
		...
		gui.InputField("class", f.Width, "250", f.AssetId, ninePatch[9], f.Text, "Cool", f.InputFieldMargin, "10",
		...
		gui.Visual("stepper", f.AssetId, ninePatch[9], f.Text, "10/10", f.TextAlignmentY, "0.5", f.GapX, "0",
		...
		gui.Menu("dropdown", f.NewRow, "", f.AssetId, ninePatch[9], f.Text, "V List selection", f.Width, "410",
		...
		gui.Slider("slider1", f.AssetId, ninePatch[10], f.EdgeTop, "0", f.EdgeBottom, "0", f.NewRow, "",
		...
		gui.Slider("slider2", f.AssetId, ninePatch[10], f.EdgeTop, "0", f.EdgeBottom, "0", f.NewRow, "",
		...
		gui.Visual("slider2-100", f.ThemeId, "label", f.Text, "100", f.TextLineHeight, "25", f.GapX, "355",
			f.Width, "40", f.Height, "25", f.TextAlignmentX, "0.5"),
		gui.Visual("divider", f.AssetId, ninePatch[12], f.EdgeTop, "0", f.EdgeBottom, "0", f.NewRow, "",
		...
		gui.Slider("tab1-slider", f.AssetId, ninePatch[10], f.EdgeTop, "0", f.EdgeBottom, "0", f.NewRow, "",
		...
		gui.Visual("tab2", f.ThemeId, "label", f.Text, "Second Tab", f.ToggleButtonId, "outside2", f.Hidden, "1",
			f.NewRow, "", f.Width, "250"),
		gui.InputField("tab2-inputbox", f.Width, "250", f.AssetId, ninePatch[9], f.Text, "Cool Tab!",
		...
		gui.Visual("tab5", f.ThemeId, "label", f.Text, "Fifth Tab", f.ToggleButtonId, "outside5", f.Hidden, "1",
			f.NewRow, "", f.Width, "250"),
		gui.Visual("divider-2", f.AssetId, "", f.EdgeTop, "0", f.EdgeBottom, "0", f.NewRow, "",
			f.Width, "410", f.Height, "20"),
		...
		gui.Visual("divider-3", f.AssetId, ninePatch[12], f.EdgeTop, "0", f.EdgeBottom, "0", f.NewRow, "",
			f.Width, "410", f.Height, "20"),
		gui.Draggable("slot-1", f.NewRow, "25", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0],
			f.DraggableAssetId, icons[50]),
		gui.Draggable("slot-2", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0], f.DraggableAssetId, icons[100]),
		gui.Draggable("slot-3", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0], f.TextColor, "test"),
		gui.Draggable("slot-4", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		gui.Draggable("slot-5", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		gui.Draggable("slot-6", f.NewRow, "", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		gui.Draggable("slot-7", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		gui.Draggable("slot-8", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		gui.Draggable("slot-9", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		gui.Draggable("slot-10", f.Width, "100", f.Height, "100", f.AssetId, ninePatch[0]),
		//=================================================================
		gui.Container("menu", "", "", "410", "150", f.ThemeId, "button", f.Hidden, "1", f.GapX, "5", f.GapY, "5"),
		gui.Visual("menu-bgr", f.FillContainer, "", f.AssetId, ninePatch[0], f.Color, "200 200 200 255"),
		...
		gui.Tooltip("tooltip", f.AssetId, ninePatch[7], f.Width, "350", f.TextAlignmentX, "0.5", f.TextAlignmentY, "0.5"),
	))
