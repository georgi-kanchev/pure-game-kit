...
func GUIs() {
	...
	var hud = gui.New(
		...
		gui.Visual("outside1-label", p.ThemeId, "label", p.Text, "Outside1", p.NewRow, ""),
		gui.Visual("outside2-label", p.ThemeId, "label", p.Text, "Outside2", p.NewRow, ""),
		gui.Visual("outside3-label", p.ThemeId, "label", p.Text, "Outside3", p.NewRow, ""),
		gui.Visual("outside4-label", p.ThemeId, "label", p.Text, "Outside4", p.NewRow, ""),
		gui.Visual("outside5-label", p.ThemeId, "label", p.Text, "Outside5", p.NewRow, ""),
		// ======================================================
		gui.Container("menu", "0", "0", "820", "300", p.ThemeId, "button", p.Hidden, "+"),
