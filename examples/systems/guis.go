...
func GUIs() {
	...
	var hud = gui.NewFromXMLs(cam, gui.NewElementsXML(
		...
		gui.Theme("button-hover", f.Color, "255 255 255 255", f.Width, "150", f.Height, "50",
			f.AssetId, ninePatch[5], f.TextAlignmentX, "0.5", f.TextAlignmentY, "0.3",
		...
		gui.Theme("checkbox-on", f.Color, "220 220 220 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.AssetId, ninePatch[9], f.TextColor, "80 80 80 255", f.TextLineHeight, "35",
		...
		gui.Theme("checkbox-on-hover", f.Color, "255 255 255 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.AssetId, ninePatch[9], f.TextColor, "80 80 80 255", f.TextLineHeight, "35", f.Text, "X",
		...
		gui.Theme("checkbox-off", f.Color, "220 220 220 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.ButtonThemeIdHover, "checkbox-off-hover", f.ButtonThemeIdPress, "checkbox-off-press",
		...
		gui.Theme("checkbox-off-hover", f.Color, "255 255 255 255", f.Width, "50", f.Height, "50", f.GapX, "10",
			f.GapY, "10", f.AssetId, ninePatch[9]),
		...
		gui.InputField("class", f.Width, "250", f.AssetId, ninePatch[9], f.Text, "Cool", f.InputFieldMargin, "10",
			f.InputFieldPlaceholder, tag.OutlineColor("Type...", palette.LightGray), f.Disabled, "1"),
		gui.Visual("stepper-label", f.ThemeId, "label", f.Text, "Stepper", f.NewRow, ""),
		gui.Button("step-left", f.Width, "50", f.Text, "L", f.Disabled, "1",
		...
		gui.Slider("slider1", f.AssetId, ninePatch[10], f.NewRow, "",
			f.Width, "410", f.Height, "20", f.Disabled, "1"),
		...
		gui.Slider("slider2", f.AssetId, ninePatch[10], f.NewRow, "",
		...
		gui.Visual("slider2-100", f.ThemeId, "label", f.Text, "100", f.TextLineHeight, "25", f.GapX, "355",
			f.Width, "40", f.Height, "25", f.TextAlignmentX, "0.5"),
		gui.Visual("divider", f.AssetId, ninePatch[12], f.NewRow, "",
		...
		gui.Slider("tab1-slider", f.AssetId, ninePatch[10], f.NewRow, "",
		...
		gui.Visual("tab5", f.ThemeId, "label", f.Text, "Fifth Tab", f.ToggleButtonId, "outside5", f.Hidden, "1",
			f.NewRow, "", f.Width, "250"),
		gui.Visual("divider-2", f.AssetId, "", f.NewRow, "",
		...
		gui.Visual("divider-3", f.AssetId, ninePatch[12], f.NewRow, "",
			f.Width, "410", f.Height, "20"),
