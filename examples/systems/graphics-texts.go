...
func Texts() {
	...
	for window.KeepOpen() {
		...
		textBox.Text = text.New("Lorem ", tag.Color("ipsum dolor", palette.Red), " sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et ", tag.Underline("dolore magna", 1), " aliqua. Ut enim ad minim veniam, quis nostrud ", tag.Asset(tiles[162]), " exercitation ullamco laboris nisi ut ", tag.Box("aliquip", 1), " ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate ", tag.Strikethrough("velit esse", 1), " cillum doloreeu fugiat nulla pariatur.")
