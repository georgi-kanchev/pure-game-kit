...
func MemoryUsage() string {
	...
	memBuf = append(memBuf, " reserved from OS\n\n"...)

	memBuf = appendByteSize(memBuf, int(m.HeapSys))
	memBuf = append(memBuf, " heap reserved\n"...)
