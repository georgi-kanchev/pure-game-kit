...
func dyn(owner *container, value string, defaultValue string) string {
	...
	if owner != nil {
		...
		value = text.ReplaceWith(value, dynamic.OwnerRightX, ownerRx)
		value = text.ReplaceWith(value, dynamic.OwnerTopY, ownerTy)
		value = text.ReplaceWith(value, dynamic.OwnerBottomY, ownerBy)
		value = text.ReplaceWith(value, dynamic.OwnerCenterX, ownerCx)
		value = text.ReplaceWith(value, dynamic.OwnerCenterY, ownerCy)
	}

	value = text.ReplaceWith(value, dynamic.CameraCenterX, camCx)
	value = text.ReplaceWith(value, dynamic.CameraCenterY, camCy)
	value = text.ReplaceWith(value, dynamic.CameraLeftX, camLx)
	value = text.ReplaceWith(value, dynamic.CameraRightX, camRx)
	value = text.ReplaceWith(value, dynamic.CameraTopY, camTy)
	value = text.ReplaceWith(value, dynamic.CameraBottomY, camBy)
	value = text.ReplaceWith(value, dynamic.CameraWidth, camW)
	value = text.ReplaceWith(value, dynamic.CameraHeight, camH)
